/*
  ...
  - Garante que a mensagem tenha no mínimo 10 caracteres.
  - Exibe mensagens de erro específicas para cada campo.
  - Remove erros dinamicamente enquanto o usuário digita.
  - Mostra mensagem de sucesso ao enviar corretamente.
*/
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (evento) {
    ...
    if (ok) {
      ...
      if (sucesso) {
        sucesso.textContent =
          'Mensagem validada e enviada com sucesso. Obrigado pelo contato!'
      }
    }
  })
})